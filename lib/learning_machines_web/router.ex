defmodule LearningMachinesWeb.Router do
  ...
  import LearningMachinesWeb.UserAuth
  ...
  scope "/", LearningMachinesWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{LearningMachinesWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", LearningMachinesWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{LearningMachinesWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", LearningMachinesWeb do
    ...
    live_session :current_user,
      on_mount: [{LearningMachinesWeb.UserAuth, :mount_current_user}] do
